            ...
            try {
                ...
                Java.choose("ms.bd.c.r4", {
                    onMatch: function(inst) {
                        ...
                        // Write shell vars to stdout as KEY=VALUE
                        console.log("URL=" + url);
                        console.log("TSMS=" + tsMs);
                        var it = m.keySet().iterator();
                        while (it.hasNext()) {
                            var k = it.next();
                            // Replace - with _ for shell var names
                            var vn = k.replace(/-/g, "_");
                            console.log(vn + "=" + m.get(k).toString());
                        }
                        console.log("DONE=1");
                    },
                    onComplete: function() {}
